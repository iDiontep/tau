...
;***********************************************
.include "m16def.inc"
; присоединение файла описаний; TXC 6 11
...
;
;INIT USART
       ldi   temp_L,29;(Частота кв. 9,216 мГц,скорость обмена 19200),U2X0=0,
       ldi   temp_H,00 
	   out   UBRRL,temp_L;задаем скорость передачи
	   out   UBRRH,temp_H
	   ldi   temp_L,(1<<RXEN)|(1<<RXCIE); разрешение прерывания по приему
	   out   UCSRB,temp_L
	   ldi   temp_L,(1<<URSEL)|(1<<UCSZ0)|(1<<UCSZ1);UCSZ2=0,UCSZ1=1,UCSZ0=1 - 8 bit;1 stop bit,
	   out   UCSRC,temp_L;
