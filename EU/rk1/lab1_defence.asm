...
End_prog:
sbic PINB, 4       ; Check if button on PB4 is pressed
    rjmp CheckCounter      ; Button not pressed, continue loop
delay_3:  rcall delay_DK  ;задержка для подавлениядребезга контактов
;	   
Key_end:  sbis  PinB,4  ;проверка отпускания кнопки
          rjmp  Key_end	    
delay_4:  rcall delay_DK 
...
TABLE:    .db   0b00000001,0b00000010; коды "0","1"
          .db   0b00000100,0b00001000; коды "2","3"
